                ...
                for (const [filename, file] of Object.entries(bundle)) {
                    ...
                    if (/\.html?$/.test(filename)) {
                        ...
                        this.emitFile({
                            ...
                            fileName: filename,
                            source: file.source
                                .replace(/<\/head>/i, `<script>!function(){"use strict";document.addEventListener("DOMContentLoaded",(function(){document.body.classList.remove("no-js");var e=new Image;e.onload=e.onerror=function(){var t=1===e.height;if(document.body.classList.add(t?"webp":"no-webp"),!t){var n=function(e){if(e instanceof HTMLImageElement)try{var t=e.src,n=new RegExp("^([^#?]+\\.)webp(\\?([^#]*&)?from-format=(jpe?g|png|gif|svg)([&#].*)?)$","i");n.test(t)&&(e.src=t.replace(n,(function(e,t,n,o,a){return"".concat(t).concat(a).concat(n)})))}catch(e){console.log("[vite:imagemin-upload] "+(null==e?void 0:e.message))}};document.body.querySelectorAll("img").forEach(n),new MutationObserver((function(e){try{for(var t=0,o=e;t<o.length;t++){var a=o[t];"attributes"===a.type&&["src"].includes(a.attributeName||"")?n(a.target):"childList"===a.type&&a.addedNodes.forEach((function(e){e instanceof HTMLImageElement?n(e):e instanceof Element&&e.querySelectorAll("img").forEach(n)}))}}catch(e){console.log("[vite:imagemin-upload] "+(null==e?void 0:e.message))}})).observe(document.body,{subtree:!0,childList:!0,attributes:!0,attributeFilter:["src"],characterData:!1})}},e.src="data:image/webp;base64,UklGRhoAAABXRUJQVlA4TA0AAAAvAAAAEAcQERGIiP4HAA=="}))}();
</script></head>`)
                                .replaceAll("\\", "\\\\"),
                        });
                        continue;
